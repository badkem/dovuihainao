...
class _WidgetButtonAnswerState extends State<WidgetButtonAnswer> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Provider.of<QuizViewModel>(context, listen: false).answer(widget.question);
      },
              ...
              children: [
                Padding(
                  ...
                  child: Image.asset(_isPress
                      ? 'assets/images/btn_answer_hover.png'
                      : 'assets/images/btn_answer.png',gaplessPlayback: true,),
                ),
                _head(widget.type),
                Positioned(
                  left: 90,
