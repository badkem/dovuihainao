...
class WidgetDialogFalse extends StatefulWidget {
  final Function onTap;
  final String description;

  const WidgetDialogFalse({Key key, this.onTap, this.description}) : super(key: key);

  @override
  _WidgetDialogFalseState createState() => _WidgetDialogFalseState();
}

class _WidgetDialogFalseState extends State<WidgetDialogFalse>
